          ...
          <div class="small_center_div">
            <div id="tabs">
                <ul>
                    ...
                    <li><a href="#tabs-3">送貨地址</a></li>
                    <li><a href="#tabs-4">修改密碼</a></li>
                </ul>
                <div id="tabs-1">
                    ...
                    <div class="profile_desc">
                        <ol class="small_font2">
                       	  <li><div class="name">kenoscar</div>
                       	  <div class="lbl_div_right_edit"><span class="edit_text" title="編輯">編輯</span><img class="edit_img" title="編輯" src="images/edit-yellow.gif" /></div></li>
                    ...
                    <DIV>
                        ...
                        <UL class="area_clearfix_top">
                            ...
                            <LI class="house_shop_nounder"><div class="lbl_div_left">地址：</div>台中縣太平市宜佳街40巷10號11樓</LI>
                ...
                <div id="tabs-3">
                	<div>
                		<h4>收貨地址管理</h4>
                        <UL class="area_clearfix_top">
                        	<LI class="house_shop_nounder"><div class="lbl_div_left">收件者姓名：</div><div class="lbl_div_center">賴建宏</div>
                            	<div class="lbl_div_right_edit"><span class="edit_text" title="編輯">編輯</span><img class="edit_img" title="編輯" src="images/edit-yellow.gif" /></div>
                            </LI>
                            <LI class="house_shop_nounder"><div class="lbl_div_left">性別：</div>男</LI>
                            <LI class="house_shop_nounder"><div class="lbl_div_left">聯絡電話：</div>0422763760</LI>
                            <LI class="house_shop_nounder"><div class="lbl_div_left">手機號碼：</div>0923832647</LI>
                            <LI class="house_shop_nounder"><div class="lbl_div_left">送貨地址：</div>411 台中縣太平市宜佳街40巷10號11樓</LI>
                            <LI class="house_shop_nounder"><div class="lbl_div_left">指定到貨時段：</div>下午 12點~17點</LI>
                        </UL>
                    </div>
                </div>
                <div id="tabs-4">
                	<UL class="area_clearfix_top">
                        <LI class="house_shop_nounder"><div class="lbl_div_left">原密碼：</div><input name="password" type="password" /></LI>
                        <LI class="house_shop_nounder"><div class="lbl_div_left">新密碼：</div><input name="newpassword" type="password" /></LI>
                        <LI class="house_shop_nounder"><div class="lbl_div_left">確認新密碼：</div><input name="cofrmpassword" type="password" /></LI>
                        <LI class="house_shop_nounder"></LI>
                        <LI class="house_shop_nounder"><div class="lbl_div_left"></div><input type="button" class="but_ok" value="確認修改" /></LI>
                    </UL>
                </div>
            </div>
